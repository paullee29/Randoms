...
public class FirstNonRepeating {
	...
	public static void main (String args[] ) {
		System.out.println(firstNonRepeatingCharwoHash ("abbbbcggechrtgfdafsggrxgjhj"));
	}
    ...
    public static char firstNonRepeatingCharwoHash (String s) {
    	int firstIndex = 0;
    	char[] firstList = new char[26];
    	byte[] orderList = new byte[26];
    	...
    	for (int i=0; i<firstList.length;i++) {
    		System.out.print( (char) (firstList[i]+'a') +", ");
    	}
    	...
    	for (int index = 0; index < firstIndex; index++) {
    	    if (orderList[firstList[index]] == 1) {
